...
export const loadReadings = (patient_id, token) => {
    var date_from = localStorage.getItem("date_from")?localStorage.getItem("date_from"):"2017-01-01";
    var time_from = localStorage.getItem("time_from")?localStorage.getItem("time_from"):"00:00";
    var date_to = localStorage.getItem("date_to")?localStorage.getItem("date_to"):"2018-12-20";
